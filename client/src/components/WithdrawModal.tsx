...
interface WithdrawModalProps {
  ...
  onClose: () => void;
  onConfirm: () => void;
  application: ApplicationWithPet | null;
  isLoading?: boolean;
}
...
export default function WithdrawModal({
  ...
  const { pet, application: app } = application;
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li className="flex items-start gap-2">
                <span className="text-red-500 mt-0.5">•</span>
                <span>You'll need to submit a new application if you change your mind</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-500 mt-0.5">•</span>
                <span>The shelter will be notified of your withdrawal</span>
              </li>
            </ul>
          </div>
        </div>
